...
description: >-
  Load before completing an investigation, scout, structured review, or visual/Lavish review; before closing one with an unresolved captain decision; when recording or routing the captain's answer; or on `RECORD DIVERGENCE`.
