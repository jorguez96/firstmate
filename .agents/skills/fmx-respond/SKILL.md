...
name: fmx-respond
description: >-
  Load on Relay `x-mention`, `x-mode-error`, milestone/terminal, or `public-followup` wakes, or when a promised final public reply must be posted or reconciled.
  Use only when Relay is enabled.
