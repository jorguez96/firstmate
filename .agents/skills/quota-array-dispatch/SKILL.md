...
description: >-
  Load when dispatch resolution yields multiple profile candidates.
  Rank candidates by quota-axi `spendPriority` after the three gates.
...
## Intake procedure moved from AGENTS.md section 4
