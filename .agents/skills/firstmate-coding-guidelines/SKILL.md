...
description: >-
  Load before changing firstmate shared tracked material or briefing such work.
  Covers placement, ownership, inline stubs, size, triggers, style, and verification rules.
