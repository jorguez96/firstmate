...
print_backlog_pointer() {
  printf 'Parked decision details load on demand with tasks-axi list --state held --repo <registered-project> and bin/fm-tasks-axi.sh show <id> --full; use tasks-axi list --state held for unassigned items.\n'
